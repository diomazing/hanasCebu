...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div class="container px-5">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto me-4 my-3 my-lg-0">
            <li class="nav-item">
              <a class="nav-link me-lg-3" href="#features">FeaturesHere</a>
            </li>
            <li class="nav-item">
              ...
              <div class="device-wrapper">
                ...
                >
                  <div class="screen bg-black">
                    ...
                    <img src="assets/img/Landing.png" style="height: 100%" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row gx-5">
                <div class="col-md-6 mb-5">
                  ...
                  <div class="text-center">
                    ...
                    ></i>
                    <h3 class="font-alt">Mobile Application</h3>
                    <p class="text-muted mb-0">
                      Mobile ready and you can use it anywhere in Cebu!
                    </p>
                  </div>
                </div>
                <div class="col-md-6 mb-5">
                  ...
                  <div class="text-center">
                    <i
                      ...
                      "
                    ></i>
                    <h3 class="font-alt">Earn Money</h3>
                    <p class="text-muted mb-0">
                      Generate income through the accesibility of your phone!
                    </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6 mb-5 mb-md-0">
                  ...
                  <div class="text-center">
                    ...
                    ></i>
                    <h3 class="font-alt">Earn Rewards</h3>
                    <p class="text-muted mb-0">
                      Achieve your milestones and reap your rewards!
                    </p>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="text-center">
                    <i
                      ...
                      "
                    ></i>
                    <h3 class="font-alt">Validated Workers</h3>
                    <p class="text-muted mb-0">
                      Skilled Workers are carefully validated to ensure good
                      people come at your service!
                    </p>
                  </div>
                </div>
              </div>
        ...
        >
          <div class="col-12 col-lg-5">
            <h2 class="display-4 lh-1 mb-4">
              Creating a portal of opportunities for all
            </h2>
            <p class="lead fw-normal text-muted mb-5 mb-lg-0">
              Hanas will always cater the need for our blue collared skilled
              workers to have their own online platform and showcase their
              individual talents through their skills in craftsmanship.
            </p>
          </div>
          <div class="col-sm-8 col-md-6">
            <div class="px-5 px-sm-0">
              <img
                ...
                src="https://source.unsplash.com/s1M0ncSl9l4/900x900"
                alt="..."
              />
            </div>
          </div>
    ...
    <section class="bg-gradient-primary-to-secondary" id="download">
      <div class="container px-5">
        <h2 class="text-center text-white font-alt mb-4 g-5">
          Get the app now!
        </h2>
        <div
          class="
    ...
    <footer class="bg-black text-center py-5">
      <div class="container px-5">
        <div class="text-white-50 small">
          <div class="mb-2">&copy; Hanas 2021. All Rights Reserved.</div>
          <!-- <a href="#!">Privacy</a>
